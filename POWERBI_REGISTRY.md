...
| BMX-DQ-003 | BMX | NO_RELATED_RECORDS | PARTICIPANT | PARTICIPANT_NO_EVENT_PARTICIPATION | `POWERBI_QUERIES/BMX.sql` | Approved |
| BMX-DQ-004 | BMX | MISSING_VALUES | TOURNAMENT_STAGE | TOURNAMENT_STAGE_MISSING_AGE_CLASS | `POWERBI_QUERIES/BMX.sql` | Approved |
| BMX-DQ-005 | BMX | NO_RELATED_RECORDS | TOURNAMENT_STAGE | TOURNAMENT_STAGE_NO_EVENTS | `POWERBI_QUERIES/BMX.sql` | Approved |
| BMX-DQ-006 | BMX | DATE_RANGE_MISMATCH | TOURNAMENT_STAGE | TOURNAMENT_STAGE_DATE_RANGE_MISMATCH | `POWERBI_QUERIES/BMX.sql` | Approved |
...
| BMX-DQ-013 | BMX | NO_RELATED_RECORDS | TEMPLATE | TEMPLATE_NO_TOURNAMENTS_OR_STAGES | `POWERBI_QUERIES/BMX.sql` | Approved |
...
| BMX-DQ-017 | BMX | NO_RELATED_RECORDS | COMP.RANK | COMP.RANK_NO_PARTICIPANTS | `POWERBI_QUERIES/BMX.sql` | Approved |
